...
- We secure your customers' pricing information by staying compliant with GDPR. Moreover, we do not store any personally identifiable
information.
...
- Implementing network, application and operational level security policies. We are currently working with a security assessmgnet
vendor to conduct an independent penetration testing and will make the results available shortly
