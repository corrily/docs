...
[^2]: At the moment, only base prices in `USD` are allowed. We plan to support other base currencies soon. You can still set prices
in other currencies when localizing currencies.
