...
Before you show prices on your pricing interfaces using Corrily and start experimentation, please review this launch
checklist to make sure everything is set-up properly:

- **reate Corrily products** for every product that you wish to integrate with us. If you have a large catalog of products,
