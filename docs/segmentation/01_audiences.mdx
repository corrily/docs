...
or any price or packaging changes that you roll out. For e.g. your link shortener subscription service may generally be
seeing higher churn amongst the `freelancers` audience segment, and `boutique creative studios` may have higher willingness
...
<img src="../img/Create_audience.png" width ="2000" />
