...
your pricing and packaging strategy is working. Attributes can either be a *string*, a *number* or a *boolean* value.
You can use the Attributes tab under Audiences to create and manage all your user attributes. When you create new audiences,
