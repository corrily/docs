...
<Param body="{product_api_id}" type="string" required>
...
<Expandable title="<stripe>">
    <ResponseField name="type" type="string" required>
        <Param>Should be set to equal `stripe`.</Param>
    </ResponseField>
