...
api: "DELETE https://client.corrily.com/v1/subscriptions/{user_id}/{origin}/{origin_id}"
---
...
<Param body="created" type="integer" required>
...
<Param body="currency" type="enum" required>
...
<Param body="status" type="enum" required>
